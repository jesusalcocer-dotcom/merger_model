...
- Any individual who is contributing, rolling, or exchanging equity from the target entity into a buyer-side entity is a seller. They are transferring value from the sell side to the buy side. Assign role ['seller'] to such individuals. The 'seller_rep' role is reserved exclusively for a person or entity formally appointed to act as representative of the seller group for post-closing matters such as indemnification claims, escrow disputes, and communications with the buyer. Do not confuse management rollover with shareholder representation.
- When an entity's jurisdiction is not explicitly stated but can be reasonably inferred from context, infer it. US private equity funds, holding companies, and acquisition vehicles are almost always organized in Delaware unless stated otherwise. Apply this default when no jurisdiction is given for such entities.
